...
const Footer = async () => {
  ...
  const { pbo_number, npo_number } = data.acf

  return html`
    <footer class="main-footer">
      <div class="footer-content">
        <p>
          <strong>PBO number: </strong><span>${pbo_number}</span>
          <strong>NPO number: </strong><span>${npo_number}</span>
        </p>
        <div class="social-links">
          ...
          <a href="https://www.linkedin.com/in/design26/" target="_blank">
